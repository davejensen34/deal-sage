...
- Milestone 4 is active. Issue #69 establishes the durable model-proposal and execution-provenance foundation; Issue #64 is the next productization workstream. No new live model calls or spending are authorized.
