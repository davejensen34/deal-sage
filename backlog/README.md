...
- The approved discovery lead prioritization follow-up (working label Milestone 6.1) is implemented in PR #127 under retrospective Issue #126. See `milestones/milestone-6.1.md` for scope, validation and the process repair. Milestone 7 is approved and in progress under GitHub milestone 12 and Issues #128–#130. Typed transition policies and evidence-review integration are implemented in #128/#129; Issue #130 now has a validated offline comparative evaluation. Live quality and the milestone closeout decision remain open. Live quality gates remain explicit.
