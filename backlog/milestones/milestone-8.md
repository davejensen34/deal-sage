...
- 8.3–8.6 remain pending. Next connect source access/retrieval and evidence-backed investigation to the case UI. The live cohort and cost envelope must be frozen before validation calls.
