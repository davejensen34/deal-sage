...
| API sorting | validated | endpoint implementation; UI control is a bounded gap |
...
| Initial schema migration | in_progress | Alembic configured; initial revision required |
