...
- #118 removes insecure pilot defaults, hardens proxy/headers/dependency health, boots the full stack in CI, records bounded vulnerability checks, and establishes a measured performance baseline (implemented and locally validated; PR/CI pending).
