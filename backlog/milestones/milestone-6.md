...
- #117 separates liveness/readiness and exposes role-limited, aggregate-safe schema, storage, audit, failure, source/model health, and cost visibility (implemented and validated; PR pending).
