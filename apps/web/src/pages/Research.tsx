...
export function Research(){
  ...
  if(sources.isLoading||result.isLoading||funnel.isLoading||trail.isLoading)return <div className="loading">Loading research evidence…</div>;
  if(sources.isError||result.isError||funnel.isError||trail.isError||!sources.data?.[0]||!result.data||!funnel.data||!trail.data)return <div className="empty"><AlertTriangle/><h3>Research result unavailable</h3><p>The recorded experiment could not be loaded.</p></div>;
