...
Workstreams 4.1–4.4 are implemented and offline validated. The separately approved 4.5 run stopped after three bounded search calls because the frozen evidence packet did not reproduce; no evidence reached a model and no live quality claim resulted. Workstream 4.6 must reconcile that negative integration evidence and decide the permissible Milestone 5 scope. The durable scope and definition of done are in `backlog/milestones/milestone-4.md`.
