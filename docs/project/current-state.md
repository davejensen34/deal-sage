...
Record attributable analyst dispositions for the three final valid ambiguity proposals and selected business-extraction proposals, then route only the supported Utah case into the small real review queue. Reconcile Issue #87 before starting Issue #84. Do not activate Milestone 5 automatically.
