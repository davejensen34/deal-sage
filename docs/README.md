...
- `deployment/` contains operator setup that supplements the root README, including [pilot authentication](deployment/pilot-authentication.md), [backup/recovery](deployment/pilot-recovery.md), [operational health](deployment/pilot-operations.md), and [single-host hardening](deployment/pilot-hardening.md).
